layui.define([ 'layer', 'form' ], function(exports) {
	...
	$(function(){
		var playerId = layui.sessionData('playerInfo').playerId;
		var jsonString = '{"playerId":"'+ playerId +'"}';
		getPlayerById(jsonString, form);//通过ID获取球员
	});
	...
	exports('modifyPlayer', {}); // 注意，这里是模块输出的核心，模块名必须和use时的模块名一致
});